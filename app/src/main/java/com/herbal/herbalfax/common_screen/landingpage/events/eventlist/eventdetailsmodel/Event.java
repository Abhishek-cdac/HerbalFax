...
public class Event {
    ...
    private String mEventCAt;
    @SerializedName("EventCOn")
    private String mEventCOn;
    @SerializedName("EventComments")
    private String mEventComments;
    ...
    public String getEventComments() {
        return mEventComments;
    }

    public void setEventComments(String eventComments) {
        mEventComments = eventComments;
    }
