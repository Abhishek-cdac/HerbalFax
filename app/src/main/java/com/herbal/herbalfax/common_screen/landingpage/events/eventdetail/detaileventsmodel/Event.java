...
public class Event {
    ...
    @SerializedName("extra_view")
    private Long extraView;
    @Expose
    ...
    public Object getEventDay() {
        return eventDay;
    }

    public void setEventDay(Object eventDay) {
    ...
    public Long getExtraView() {
        return extraView;
    }

    public void setExtraView(Long extraView) {
