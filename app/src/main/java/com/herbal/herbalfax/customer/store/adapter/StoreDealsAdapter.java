...
public class StoreDealsAdapter extends RecyclerView.Adapter<StoreDealsAdapter.ViewHolder> {
    ...
    public StoreDealsAdapter(ArrayList<StoreProduct> lst_deal, Context applicationContext) {
        picasso = Picasso.get();
    ...
    @Override
    public void onBindViewHolder(@NonNull StoreDealsAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
