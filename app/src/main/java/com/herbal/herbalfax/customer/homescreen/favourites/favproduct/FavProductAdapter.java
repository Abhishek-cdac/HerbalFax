package com.herbal.herbalfax.customer.homescreen.favourites.favproduct;
...
public class FavProductAdapter extends RecyclerView.Adapter<FavProductAdapter.ViewHolder> {
    ...
    ArrayList<com.herbal.herbalfax.customer.homescreen.favourites.favproduct.model.StoreProduct> lst_product;
    Context mContext;
    private final Picasso picasso;
    Onclick itemClick;


    public FavProductAdapter(ArrayList<com.herbal.herbalfax.customer.homescreen.favourites.favproduct.model.StoreProduct> lst_product, Context applicationContext) {
        picasso = Picasso.get();
    ...
    public FavProductAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fav_productlist_item, parent, false);
