...
public class NewDealsAdapter extends RecyclerView.Adapter<NewDealsAdapter.ViewHolder> {

    ArrayList<StoreProduct> lst_deal;
    Context mContext;
    private final Picasso picasso;

    public NewDealsAdapter(ArrayList<StoreProduct> lst_deal, Context applicationContext) {
        picasso = Picasso.get();
    ...
    @NonNull
    @Override
    public NewDealsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NewDealsAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
