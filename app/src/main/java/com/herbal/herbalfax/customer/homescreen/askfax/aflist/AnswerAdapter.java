...
import com.herbal.herbalfax.customer.homescreen.feed.AddCommentActivity;
...
public class AnswerAdapter extends RecyclerView.Adapter<AnswerAdapter.ViewHolder> {
    private ArrayList<QueAnswer> commentList;
    ...
    public AnswerAdapter(Context applicationContext, ArrayList<QueAnswer> lst_getComment) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AnswerAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        holder.name.setText(commentList.get(position).getUFullName());
        holder.desc.setText(commentList.get(position).getAFADesc());
...
//        }
    ...
    /*    try {
        ...
        try {
            if (commentList.get(position).getAnswerCreatedTime() != null) {
                String timeFormat = commentList.get(position).getAnswerCreatedTime();
        ...
        String commentId = commentList.get(position).getIdafAnswers();

        holder.like.setText(commentList.get(position).getAFALikes() + " Likes");
