...
public class NewOrderAdapter extends RecyclerView.Adapter<NewOrderAdapter.MyViewHolder> {
    ...
    public NewOrderAdapter(List<Group> lst_completeOrder, FragmentActivity activity, Onclick itemClick) {
...
//    }
    ...
    public NewOrderAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.new_order_listitem, parent, false);
